...
# this code is a mess....
# I wrote this while learning python.. so....
...
def igrappa(data, R = 2, width = 5, height = 4):    
    data_R = data
    ...
    images = ifft2c(imageK)
    # rsos for now, will do a sense combine (opt snr PB Roemer) later 
    return rsos(images)